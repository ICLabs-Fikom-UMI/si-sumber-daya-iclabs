        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                <li class="nav-item me-4">
                    <a class="nav-link text-white" href="http://localhost:8080/tubesmvc/public/home/index.php">Home</a>
                </li>
                <li class="nav-item me-4">
                    <a class="nav-link text-white" href="http://localhost:8080/tubesmvc/public/home/index.php#kepalaLab">Kepala Lab</a>
                </li>
                <li class=" nav-item me-4">
                    <a class="nav-link text-white" href="http://localhost:8080/tubesmvc/public/home/index.php#laboran">Laboran</a>
                </li>
                <li class="nav-item me-4">
                    <a class="nav-link text-white" href="http://localhost:8080/tubesmvc/public/home/index.php#asisten">Asisten Laboratorium</a>
                </li>
            </ul>
        </div>
    </div>
