...
<form action="<?= BASEURL ?>/Dashboard/edit_data_kepala_lab/<?= $data['kepala_lab']['id_user'] ?>" method="post" enctype="multipart/form-data">
    <div class="container-fluid">
        ...
        <div class="col col-md-12 mb-4 d-flex">
            <div class="container-fluid mb-4">
                ...
                <textarea name="deskripsi" id="deskripsi" cols="170%" rows="10" class="rounded-3" placeholder="Deskripsikan Diri Anda" required><?= $data['kepala_lab']['deskripsi'] ?></textarea>
            </div>
