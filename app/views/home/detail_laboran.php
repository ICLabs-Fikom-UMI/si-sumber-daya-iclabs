<div class="row mb-5" style="margin-top: 8rem; padding: 0 10rem">
    <div class="col-md-4">
        ...
        <div class="card">
            <img src="../../../public/asset/image/<?= $data['laboran']['foto_detail'] ?>" class="card-img-top object-fit-cover vh-100" style="object-position: center; height: 330.333px;" alt="Card Image">
