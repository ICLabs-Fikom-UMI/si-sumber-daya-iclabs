    ...
    <div class="container-fluid d-flex justify-content-center form-lengkapi-profil flex-column">
        ...
        <form action="">
            ...
            <div class="container mb-4">
                ...
                <input type="text" name="nim" id="nim" class="input-text-profile rounded-3"
                    placeholder="Masukkan NIM Anda" required>
            </div>
            <div class="container mb-4">
                <label class="fs-6" for="kelas">Kelas <span class="text-danger">*</span></label><br>
                <input type="text" name="kelas" id="kelas" class="input-text-profile rounded-3"
            ...
            <div class="container mb-4">
                ...
                <input type="email" name="kelas" id="kelas" class="input-text-profile rounded-3"
                    placeholder="Masukkan Email Anda" required>
            </div>
            <div class="container mb-4">
                <label class="fs-6" for="alamat">Alamat <span class="text-danger">*</span></label><br>
                <input type="text" name="alamat" id="alamat" class="input-text-profile rounded-3"
            ...
            <div class="container mb-4">
                ...
                <div class="container d-flex justify-content-start align-items-start gap-5 mb-4">
                    <div class="d-flex flex-column">
                        ...
                        <select class="form-select" aria-label="Default select example" name="angkatan" id="angkatan"
                            required>
                ...
                <div class="container mb-4">
                    ...
                    <input type="text" name="matkul_praktikum" id="matkul_praktikum" class="input-text-profile rounded-3"
                        placeholder="ex. Pemrograman Mobile, Desain Grafis, dll" required>
